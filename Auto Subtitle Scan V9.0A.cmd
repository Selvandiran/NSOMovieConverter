...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('Format Shifting to MP4. If you want to stop, please press control c in 3');"
echo 2
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('2');"
echo 1
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('1');"
echo Converting...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('Converting');"
...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('Adding subtitle stream into the movie. If you want to stop, please press control c in 3');"
echo 2
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('2');"
echo 1
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%voice%'); $speak.Rate=%voice_speed%; $speak.Speak('1');"
