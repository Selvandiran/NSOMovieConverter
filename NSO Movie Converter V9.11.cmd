...
set Sound_Folder=E:\Movie Converter Files\Alerts
...
echo -  - Format Shifting %Original_Filename% to MP4. If you want to stop, please press CTRL+C in 3...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%Speech_Voice%'); $speak.Rate=%Speech_Voice_Speed%; $speak.Speak('Format Shifting %Original_Filename% to MP4. If you want to stop, please press control c in 3');"
echo -  - 2
...
color C7
IF %Extension_Type% EQU avi %FFmpeg_Folder%\ffmpeg -hwaccel cuda -i "%Original_Filename%" -c:v h264_nvenc -vf format=yuv420p -max_muxing_queue_size 9999 -c:s mov_text "%File_Name%.mp4"

IF %Extension_Type% NEQ avi %FFmpeg_Folder%\ffmpeg -i "%Original_Filename%" -acodec copy -vcodec copy "%File_Name%.mp4"
...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%Speech_Voice%'); $speak.Rate=%Speech_Voice_Speed%; $speak.Speak('%File_Name%');"
...
if %Global_Variable_Int_1% GTR 1920 (GOTO CONVERT_BITRATE)
...
set /a Global_Variable_Int_4=2700

if %Global_Variable_Int_3% GTR %Global_Variable_Int_4% (GOTO CONVERT_BITRATE)
...
::$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
:: CONVERT BITRATE FOR FURTHER SIZE REDUCTION, BOTH RESOLUTION AND/OR BITRATE (THAT ONE TIME WHEN TOO BIG IS A CONS, AND NO SHE DIDN'T SAY THE SAME...)
:CONVERT_BITRATE
...
echo -  - Converting movie to a lower bitrate/resolution. If you want to stop, please press CTRL+C in 3...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%Speech_Voice%'); $speak.Rate=%Speech_Voice_Speed%; $speak.Speak('Converting movie to a lower bitrate or resolution. If you want to stop, please press control c in 3');"
echo -  - 2
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%Speech_Voice%'); $speak.Rate=%Speech_Voice_Speed%; $speak.Speak('2');"
echo -  - 1
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%Speech_Voice%'); $speak.Rate=%Speech_Voice_Speed%; $speak.Speak('1');"
...
PowerShell -Command "Add-Type -AssemblyName System.Speech; $speak=New-Object System.Speech.Synthesis.SpeechSynthesizer; $speak.SelectVoice('%Speech_Voice%'); $speak.Rate=%Speech_Voice_Speed%; $speak.Speak('Converting');"
color 53
%FFmpeg_Folder%\ffmpeg -hwaccel auto -i "%File_Name%.mp4" -vf "scale=1920:1080" -c:v h264_nvenc -b:v 2000k "bitrate-out.mp4"

move "%File_Name%.mp4" "backup.mp4" 1>nul 2>nul
move "bitrate-out.mp4" "%File_Name%.mp4" 1>nul 2>nul
...
echo        d888b Y8b Y8b  "88 88"     Y8P    888  "YeeP"    "88,d88  "88 88"  888 888    Y8P     "YeeP" 888     888    "YeeP" 888    
echo  ------------------------------------------------------------------------------------------------------------------------------------
echo -  - Converted Movie to Lower Bitrate/Resolution...Success!
:CHECK_RESOLUTION_BITRATE
...
:BLOCKING_FILE
echo -  - Pipeline Blocked. Add Related Video or Remove SRT/No-SRT File to Proceed. Ignore if Adobe Media Encoder is Processing...
